...
use App\Http\Controllers\Admin\Project\MasterPlanController;
...
Route::group(['prefix'=>'admin','middleware'=>'admin.auth'],function(){
    Route::group(['middleware' => ['admin.auth']], function () {
        ...
        Route::post('project/{id}/sequence', [ProjectController::class, 'projectIsSeq']);
        ...
        // master plan 
        Route::resource('projectdata/master-plan', MasterPlanController::class)->except(['update','destroy']);
        Route::post('projectdata/master-plan/{id}/update', [MasterPlanController::class,'update']);
        Route::post('projectdata/master-plan/{id}/delete', [MasterPlanController::class,'destroy']);

        Route::post('projectdata/master-plan/{id}/status', [MasterPlanController::class,'status']);
        Route::post('projectdata/master-plan/{id}/protected', [MasterPlanController::class,'MakeProtected']);
        // end master plan 
