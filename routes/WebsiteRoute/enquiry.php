...
use App\Http\Controllers\Website\ServiceEnquiryController;
...
Route::post('gvlip-enquiry', [ServiceEnquiryController::class, 'store']);
Route::post('services-enquiries',  [ServiceEnquiryController::class, 'postEnquiries']);
