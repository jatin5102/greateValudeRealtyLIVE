...
class ProjectAmenitiesGalleryController extends Controller
{
        ...
        if($validator->fails()){
            ...
            try{
                ...
                if($request->hasFile('image')){
                    ...
                    $path = $request->file('image')->storeAs('project/amenities', $filename, 'public');
                ...
                if($request->hasFile('alternative_image')){
                    ...
                    $path = $request->file('alternative_image')->storeAs('project/amenities', $filename, 'public');
    ...
    public function update(Request $request, $id)
    {
        ...
        [ 
            ...
            'alternative_image.required' => 'Image  is required',
            'alternative_image.max' => 'Maximum image size limit of 2 MB',            
            'alternative_image.mimes' => 'Only Allowed  png,jpg,jpeg,webp,svg',           
        ]);
