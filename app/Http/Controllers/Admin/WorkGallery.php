...
class WorkGallery extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'alternative_image.max' => 'Image size must not exceed 2MB.',
        ...
        if($validator->fails()){
            ...
            try{
                ...
                $path = $request->file('image')->storeAs('work-gallery', $filename, 'public');
                ...
                if($request->hasFile('alternative_image')) {
                    ...
                    $path_alt = $request->file('alternative_image')->storeAs('work-gallery', $filename, 'public');
                    $workculture->alternative_image = $path_alt;
                }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if($request->file('alternative_image')){
                ...
                $filename = time() . '_' . preg_replace('/[^A-Za-z0-9\-_]/', '_', $request->file('alternative_image')->getClientOriginalName());
                $path = $request->file('alternative_image')->storeAs('work-gallery', $filename, 'public');
