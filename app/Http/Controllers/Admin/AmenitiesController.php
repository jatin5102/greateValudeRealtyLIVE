...
class AmenitiesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
            ...
            try{
                ...
                $path = $request->file('image')->storeAs('amenities-icon', $filename, 'public');
                ...
                if($request->hasFile('alternative_image')){
                    ...
                    $alt_path = $request->file('alternative_image')->storeAs('amenities-icon', $filename, 'public');
                    $amenitiesdata->alternative_image = $alt_path;
                }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->file('alternative_image')){
            ...
            dltSingleImgFile($imagesurl);
            $filename = time() . '_' . preg_replace('/[^A-Za-z0-9\-_]/', '_', $request->file('alternative_image')->getClientOriginalName());
            $path = $request->file('alternative_image')->storeAs('amenities-icon', $filename, 'public');
