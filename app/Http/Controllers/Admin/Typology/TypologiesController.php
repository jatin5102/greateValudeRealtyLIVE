...
class TypologiesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'image' => 'nullable|mimes:png,jpg,jpeg,svg,webp|max:2048',
        ...
        if($validator->fails()){
            ...
            try{
                ...
                if($request->file('alternative_image')){
                    ...
                    $path = $request->file('alternative_image')->storeAs('typology', $filename, 'public');
                    $typology->alternative_image = $path;
                }
