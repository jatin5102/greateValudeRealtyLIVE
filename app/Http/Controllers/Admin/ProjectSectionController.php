        ...
        if($validator->fails()){
            ...
            try{
                ...
                if($request->hasFile('image')){
                    ...
                    $path = $request->file('image')->storeAs('projectSections', $filename, 'public');
                ...
                if($request->hasFile('alternative_image')){
                    ...
                    $path = $request->file('alternative_image')->storeAs('projectSections', $filename, 'public');
                    $projectSection->alternative_image = $path;
                }
