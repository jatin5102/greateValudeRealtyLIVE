        ...
        try {
            ...
            $groupedRecords = $distinctYears->map(function ($year) {
                return [
                    ...
                    'alternative_image' => TimelineImage::where('year', $year)->value('alternative_image'), // Get first timeline image
                    'records' => Timeline::where('year', $year)->get(['id', 'title', 'year', 'description', 'status', 'created_at']),
                    'images' => TimelineImage::where('year', $year)->get(['image', 'alternative_image', 'alt'])->toArray(),
                ];
            });
