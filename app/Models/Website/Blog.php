...
class Blog extends Model
{
    ...
    {
        if(!empty($this->attributes['alternative_thumbnail'])){
            if(File::exists(public_path('storage/'.$this->attributes['alternative_thumbnail']))){
                return asset('storage/'.$this->attributes['alternative_thumbnail']);
            }else{
                return  asset('default/default_project.jpg');
            }
        }
