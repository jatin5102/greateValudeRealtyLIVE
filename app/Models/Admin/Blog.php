...
class Blog extends Model
{
    ...
    protected $fillable = ['heading', 'blog_categories_id', 'slug', 'image', 'short_description', 'description', 'alt', 'thumbnail', 'alternative_image', 'alternative_thumbnail', 'date', 'status', 'meta_title', 'meta_keyword', 'meta_description', 'meta_author', 'seo_tags'];
